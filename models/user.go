...
type User struct {
	...
	ProfileImage         string    `json:"profile_image" gorm:"default:'system_images/default_profile.jpg'"` // Путь к изображению профиля
	ProfileBgImage       string    `json:"profile_bg_image" gorm:"default:'system_images/default_bg.jpg'"`   // Путь к изображению фона профиля
